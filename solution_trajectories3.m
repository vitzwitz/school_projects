function solution_trajectories3(x_0)
...
[tout,xout2] = ode45(f1,[-10,50],x_0);     %Numerically integration that find
                                        %solution curves
...
[tout2,xout3] = ode45(f2,[-10,50],x_0);
...
[tout3,xout4] = ode45(f3,[-10,50],x_0);
 
plot(tout3,xout4)

title('Solution Trajectories of Model 2 with x(0)=0.2')
