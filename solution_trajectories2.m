function solution_trajectories2(x_0)
...
[tout,xout2] = ode45(f1,[-2,5],x_0);     %Numerically integration that find
                                        %solution curves
...
[tout3,xout4] = ode45(f3,[-2,5],x_0);
 
plot(tout3,xout4)

title('Solution Trajectories of Model 1 with x(0)=0.9')
